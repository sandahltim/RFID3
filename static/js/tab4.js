...
function sortCommonNames(contractNumber, column) {
    ...
    const url = `/tab/4/common_names?contract_number=${encodeURIComponent(contractNumber)}&sort=${column}_${direction}`;
...
function sortItems(contractNumber, commonName, column) {
    ...
    const url = `/tab/4/data?contract_number=${encodeURIComponent(contractNumber)}&common_name=${encodeURIComponent(commonName)}&sort=${column}_${direction}`;
