...
// categories.js version: 2025-06-19-v2
console.log('categories.js version: 2025-06-19-v2 loaded');
...
function addMappingRow(mapping = {category: '', subcategory: '', rental_class_id: '', common_name: 'N/A', short_common_name: ''}) {
    ...
    row.innerHTML = `
        ...
        <td>
            <button class="btn btn-danger btn-sm remove-btn" onclick="removeMappingRow(this)">Remove</button>
        </td>
    `;
