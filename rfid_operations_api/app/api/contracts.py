...
from app.models import get_manager_db
...
@router.get("/open", response_model=List[ContractResponse])
async def get_open_contracts(
    ...
    for contract in contracts:
        ...
        results.append(ContractResponse(
            ...
            promised_delivery_date=contract.promised_delivery_date,
            ...
            is_manual=False or False
        ))

    return results

@router.post("/manual", response_model=ContractResponse)
async def create_manual_contract(
    ...
    return ContractResponse(
        ...
        promised_delivery_date=new_transaction.promised_delivery_date,
        actual_delivery_date=new_transaction.actual_delivery_date,
