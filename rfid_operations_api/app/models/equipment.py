...
class Equipment(Base):
    ...
    sell_price = Column(Decimal(10,2), comment="SELL - Selling price")
    dep_price = Column(Decimal(10,2), comment="DEP - Deposit price")
    dmg_waiver = Column(Decimal(10,2), comment="DMG - Damage waiver")
    ...
    per1 = Column(Decimal(10,2), comment="PER1 - Period 1")
    per2 = Column(Decimal(10,2), comment="PER2 - Period 2")
    per3 = Column(Decimal(10,2), comment="PER3 - Period 3")
    per4 = Column(Decimal(10,2), comment="PER4 - Period 4")
    per5 = Column(Decimal(10,2), comment="PER5 - Period 5")
    per6 = Column(Decimal(10,2), comment="PER6 - Period 6")
    per7 = Column(Decimal(10,2), comment="PER7 - Period 7")
    per8 = Column(Decimal(10,2), comment="PER8 - Period 8")
    per9 = Column(Decimal(10,2), comment="PER9 - Period 9")
    per10 = Column(Decimal(10,2), comment="PER10 - Period 10")

    # Rental rates 1-10 (columns 27-36)
    rate1 = Column(Decimal(10,2), comment="RATE1 - Rate 1")
    rate2 = Column(Decimal(10,2), comment="RATE2 - Rate 2")
    rate3 = Column(Decimal(10,2), comment="RATE3 - Rate 3")
    rate4 = Column(Decimal(10,2), comment="RATE4 - Rate 4")
    rate5 = Column(Decimal(10,2), comment="RATE5 - Rate 5")
    rate6 = Column(Decimal(10,2), comment="RATE6 - Rate 6")
    rate7 = Column(Decimal(10,2), comment="RATE7 - Rate 7")
    rate8 = Column(Decimal(10,2), comment="RATE8 - Rate 8")
    rate9 = Column(Decimal(10,2), comment="RATE9 - Rate 9")
    rate10 = Column(Decimal(10,2), comment="RATE10 - Rate 10")
    ...
    retail_price = Column(Decimal(10,2), comment="RetailPrice")

    # Physical specifications
    weight = Column(Decimal(10,3), comment="Weight")
    setup_time = Column(Decimal(10,2), comment="SetupTime")
    height = Column(Decimal(10,2), comment="Height")
    width = Column(Decimal(10,2), comment="Width")
    length = Column(Decimal(10,2), comment="Length")
