...
-- Generated: 2025-08-30 17:02:44
-- ============================================================================

-- Create backup tables
CREATE TABLE IF NOT EXISTS id_item_master_backup_20250830_170244 AS SELECT * FROM id_item_master;
CREATE TABLE IF NOT EXISTS pos_equipment_backup_20250830_170244 AS SELECT * FROM pos_equipment;
CREATE TABLE IF NOT EXISTS store_correlations_backup_20250830_170244 AS SELECT * FROM store_correlations;
