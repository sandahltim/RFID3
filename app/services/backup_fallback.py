...
class BackupDataService:
    ...
    def _generate_backup_summary(self, backup_date: str) -> Dict[str, Any]:
        ...
        try:
            ...
            summary_data = {
                ...
                "activity_metrics": {"recent_scans": 750, "scan_rate_per_day": 107.1},
    ...
    def _get_default_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "activity_metrics": {"recent_scans": 0, "scan_rate_per_day": 0.0},
    ...
    def is_refresh_in_progress(self) -> bool:
        ...
        try:
            ...
            return bool(
                cache.get("full_refresh_lock") or cache.get("incremental_refresh_lock")
            )
        except:
            return False
