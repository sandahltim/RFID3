...
def update_seed_data(seeds):
    """Update seed_rental_classes table."""
    for seed in seeds:
...
def full_refresh():
    try:
        ...
        current_app.logger.info("Full refresh completed")
...
def incremental_refresh():
    """Perform incremental refresh based on last refresh time."""
    try:
        state = RefreshState.query.first()
        ...
        cache.clear()
        current_app.logger.info("Incremental refresh completed")
    except Exception as e:
